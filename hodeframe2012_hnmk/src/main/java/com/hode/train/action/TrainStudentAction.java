...
import com.hode.train.model.TrainStudentDetailRepeatVO;
...
import com.hode.train.util.ProcessImageUtil;
import com.hode.train.util.TrainUtil;
import com.hode.train.util.UnZip;
...
public class TrainStudentAction extends AbstractBaseAction {
    ...
    public String addImagePreFix() {
        ...
        String toPath = ConstantUtil.TRAIN_PIC_ROOT_PATH + tranStudentModel.getIntID();
        ...
        if (studentList != null && studentList.size() > 0) {
            ...
            if (checkType.trim().equals("0")) {
                ...
                if (studentRepeatList != null && studentRepeatList.size() > 0) {
                    ...
                    // 校验图片和人员是否匹配
                    String imagePath = ConstantUtil.TRAIN_PIC_ROOT_PATH + intMainID;
